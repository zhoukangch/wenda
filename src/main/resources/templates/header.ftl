...
<head>
    ...
    <#--<script type="text/javascript" src="../static/scripts/main/jquery.js">-->
    <#--</script>-->
    <#--<script language="javascript">-->
    <script type="text/javascript">
        //创建一个show_question_form()的方法，直接跟ID属性
        function show_question_form(){
            document.getElementById("question_form").style.display="";
        }

        function hiddden_question_form(){
...
<div role="navigation" class="zu-top">
    <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
        ...
        <div class="top-nav-profile">
           <#if user?exists>
               <a href="/user/${user.id}" class="zu-top-nav-userinfo " id=":0" role="button" aria-haspopup="true" aria-activedescendant="">
                   ...
                   <img class="Avatar" src="${user.head_url}" alt="${user.name}">
        ...
        <#if user?exists>
        <button class="zu-top-add-question" id="zu-top-add-question" onclick="show_question_form()">提问</button>
        </#if>
